...
# This function is used to recommend employees for projects using Knowledge Graph.

# 1. It creates mapping:
#    Project → required skills
#    Employee → their skills

# 2. Then it compares project skills with employee skills
#    and calculates match_score based on common skills.

# 3. If no match found, it returns empty result.

# 4. It adds employee names and project names from nodes data.

# 5. Then it sorts results by project and match_score (highest first).

# 6. For each project, it selects top K employees.

# Finally, it returns recommended employees for each project based on skill matching.
