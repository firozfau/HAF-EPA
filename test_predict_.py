...
# -----------------------------------
# Step 8: Predict Top Recommendations from all candidates
# -----------------------------------
print("\n=== STEP 8: GLOBAL RECOMMENDATION PREDICTION ===")

global_predictions = predict_recommendations(
    features_df=features,
    model=trained_model,
    top_n=10,
)
...
# -----------------------------------
# Step 9: Predict for a Single Project
# -----------------------------------
print("\n=== STEP 9: SINGLE PROJECT RECOMMENDATION ===")

sample_project_id = features["project_id"].iloc[0]

project_predictions = predict_for_single_project(
    features_df=features,
...
print(f"\nTop 5 recommendations for project {sample_project_id}:")
print(project_predictions)


# -----------------------------------
# Step 10: Save Prediction Outputs
# -----------------------------------
print("\n=== STEP 10: SAVE PREDICTIONS ===")

global_prediction_path = save_predictions(
    global_predictions,
    filename="global_predictions.csv",
)

project_prediction_path = save_predictions(
    project_predictions,
    filename=f"project_{sample_project_id}_predictions.csv",
)

print("Global predictions saved to:", global_prediction_path)
print("Project predictions saved to:", project_prediction_path)
